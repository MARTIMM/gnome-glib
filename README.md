...
There are always some problems! If you find one please help by filing an issue at [my github project](https://github.com/MARTIMM/gnome-glib/issues).

# Documentation

Documentation is generated with
`pod-render.pl6 --pdf --style=pod6 --g=MARTIMM/gnome-lib lib`
...
[//]: # (---- [refs] ----------------------------------------------------------)
[changes]: https://github.com/MARTIMM/gtk-glade/blob/master/CHANGES.md
